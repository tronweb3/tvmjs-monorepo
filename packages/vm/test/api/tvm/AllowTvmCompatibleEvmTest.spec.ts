...
describe('AllowTvmCompatibleEvmTest', () => {
  ...
  it.skip('testEthRipemd160', async () => {
    ...
    const abi = JSON.parse(
      '[{"inputs":[],"name":"getRipemd160",' +
        '"outputs":[{"internalType":"bytes32","name":"output","type":"bytes32"}],' +
        '"stateMutability":"view","type":"function"}]',
    )
    const bytecode =
      '608060405234801561001057600080fd5b5060bc' +
    ...
    assert.equal(
      ...
      JSON.stringify(
        utils.abi.decodeParamsV2ByABI(
          abi[0],
          '0xa76d892cc3522eab763529dfc84b12c080ee1fe8000000000000000000000000',
        ),
      ),
    )
  })
  ...
  it.skip('testBlake2f', async () => {
    ...
    const address = OWNER_ADDRESS
    const abi = JSON.parse(
      '[{"inputs":[{"internalType":"uint32","name":"rounds",' +
    ...
    const bytecode =
      '608060405234801561001057600080fd5b506104b28061' +
